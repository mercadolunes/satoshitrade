...
var Transfer = (function ($) {
    ...
    function transfer(settings) {
        ...
        $(transferId).find(tabItemName).on("click", function () {
            ...
            if (!$(this).is(".tab-active")) {
                ...
                // 清空右侧数量
                $(transferId).find(selectedTotalNum).text("Total 0 Items");
                // 未选中项
    ...
    function generateTransfer(inputId, currentTimeStr) {
        var htmlStr =
            ...
            + '<div class="tab-item-name tab-item-name-' + currentTimeStr + ' tab-active">Markets</div>'
            + '<div class="tab-item-name tab-item-name-' + currentTimeStr + '">Pairs</div>'
            + '</div>'
            ...
            + '<input class="transfer-double-list-search-input" type="text" id="groupListSearch_' + currentTimeStr + '" placeholder="Pesquisar" value="" />'
            + '</div>'
            + '</div>'
            ...
            + '<div class="transfer-double-list-header">'
            + '<div class="transfer-double-list-search">'
            + '<input class="transfer-double-list-search-input" type="text" id="listSearch_' + currentTimeStr + '" placeholder="" value="" />'
            + '</div>'
            + '</div>'
            + '<div class="transfer-double-list-content">'
            + '<div class="transfer-double-list-main">'
            ...
            + '<div class="param-item">Selecionados</div>'
            + '</div>'
